...
exports.readTopSync = (path) => {
    let items = readTopDirSync(path)
    return items
}

exports.readSubSync = () => {
    let items = readSubDirSync(path)
    return items
}

exports.readTop = (path, step, complete) => {
    readTopDir(path,
        (err) => {
            throw err
        },
...
exports.readSub = (path, step, complete) => {
    readSubDir(path,
        (err) => {
            throw err
        },
